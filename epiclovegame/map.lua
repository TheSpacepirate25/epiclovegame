-- most of this is the old map code that drew the walls manually with coordinates, but we still use some of it for the background grid and other stuff
-- if you do delete this entire file then the game crashes when you shoot so dont do it
local map = {}
    map.walls = {}
